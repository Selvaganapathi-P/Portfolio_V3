...
const seedProjects = [
  ...
  },
  {
    ...
    category: "Full Stack",
    year: 2025,
    problem: "Preschool children needed engaging digital learning with gamification depth and parent visibility.",
    solution: "Built a platform with nine activity types, a gamification engine (XP, coins, streaks, achievements), and separate parent and teacher dashboards.",
    architecture: "React SPA on Vercel with REST API backend. Progress persisted to MongoDB. Role-based dashboards for parents and teachers.",
    challenges: [
      "Designing activity engines simple enough for ages 3–5 yet engaging",
      "Building a gamification system with streaks and achievements for daily motivation",
      "Creating separate parent and teacher dashboards with role-based access",
    ],
    techStack: ["React.js", "JavaScript", "CSS3", "Node.js", "Express.js", "MongoDB", "Vercel"],
    features: [
      ...
      "Teacher Staff Studio",
    ],
    metrics: new Map([["activityTypes", "9"], ["achievements", "16"], ["deployed", "Live on Vercel"]]),
    order: 4,
  },
  {
    title: "CineVault",
